...
function Index(props) {
  return (
    <div class="border col-span-2  h-screen flex flex-col">
      ...
      <div className="mt-auto mb-5 border-t-3 border-grey-300">
        ...
        <PalletIcon  className="w-7 h-7 cursor-pointer add-theme"/>
          ...
          <div className="w-6 h-6 bg-green-800	 rounded-full palet"></div>
          <div className="w-6 h-6 bg-yellow-100	 rounded-full palet"></div>
          <div className="w-6 h-6 bg-blue-800	 rounded-full palet"></div>
          <div className="w-6 h-6 bg-purple-800	 rounded-full palet"></div>
        </div>
